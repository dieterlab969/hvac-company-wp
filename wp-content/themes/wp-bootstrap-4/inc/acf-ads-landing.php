...
acf_add_local_field_group( array(
    ...
    'fields'                => array(
        ...
        array(
            'key'   => 'field_al_feature_title',
            'label' => 'Feature Title',
            'name'  => 'al_feature_title',
            'type'  => 'text',
            'default_value' => 'LẦN ĐẦU TIÊN RA MẮT',
        ),
        array(
            'key'   => 'field_al_feature_subtitle',
            'label' => 'Feature Subtitle',
            'name'  => 'al_feature_subtitle',
            'type'  => 'text',
            'default_value' => 'BẢO HIỂM RỦI RO KHÔNG GIAN MẠNG TẠI VIỆT NAM',
        ),
        array(
            ...
            'type'  => 'url',
            'instructions' => 'Paste the embed URL (e.g., https://www.youtube.com/embed/VIDEO_ID). Leave blank to hide video.',
        ),
        array(
            'key'          => 'field_al_feature_thumbnail',
            'label'        => 'Video Thumbnail Image',
            'name'         => 'al_feature_thumbnail',
            'type'         => 'image',
            'return_format' => 'array',
            'instructions' => 'Fallback thumbnail shown if no video URL is set.',
        ),
        array(
            'key'   => 'field_al_feature_badge_number',
            'label' => 'Discount Badge Number (e.g. 30%)',
            'name'  => 'al_feature_badge_number',
            'type'  => 'text',
            'default_value' => '30%',
        ),
        array(
            'key'   => 'field_al_feature_badge_label',
            'label' => 'Discount Badge Label',
            'name'  => 'al_feature_badge_label',
            'type'  => 'text',
            'default_value' => 'PHÍ BẢO HIỂM',
        ),
