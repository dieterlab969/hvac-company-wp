...
acf_add_local_field_group( array(
    ...
    'fields'                => array(
        ...
        array(
            ...
            'type'          => 'text',
            'default_value' => 'BACLKDES VÀ CÁC LỰA CHỌN',
        ),
        array(
            'key'           => 'field_al_pricing_coverage_label',
            'label'         => 'Card Header Label (above coverage amount)',
            'name'          => 'al_pricing_coverage_label',
            'type'          => 'text',
            'default_value' => 'QUYỀN LỢI BẢO VỆ LÊN ĐẾN',
            'instructions'  => 'Small label printed above the USD coverage amount on every card header. Leave blank to hide.',
        ),
        array(
            ...
            'sub_fields'   => array(
                ...
                // ── Header ────────────────────────────────────────────
                array(
                    'key'           => 'field_al_plan_header_image',
                    'label'         => 'Card Header Background Image',
                    'name'          => 'header_image',
                    'type'          => 'image',
                    'return_format' => 'array',
                    'preview_size'  => 'thumbnail',
                    'instructions'  => 'Dark hero/character image shown behind the coverage amount. Leave blank for solid dark background.',
                ),
                array(
                ...
                // ── Body ──────────────────────────────────────────────
                array(
                    'key'         => 'field_al_plan_benefits_label',
                    'label'       => 'Benefits Label (e.g. "QUYỀN LỢI U + O + C + R + I")',
                    'name'        => 'benefits_label',
                    'type'        => 'text',
                    'instructions'=> 'Displayed as a centred uppercase label below the card header.',
                ),
                array(
                    'key'          => 'field_al_plan_pricing_rows',
                    'label'        => 'Pricing Rows (Size M, Size XL, etc.)',
                    'name'         => 'pricing_rows',
                    'type'         => 'repeater',
                    ...
                    'sub_fields'   => array(
                        ...
                        array(
                            'key'         => 'field_al_plan_row_detail',
                            'label'       => 'Coverage Detail',
                            'name'        => 'coverage_detail',
                            'type'        => 'text',
                            'placeholder' => '1.500 USD/1 OL',
                        ),
                        array(
                            'key'         => 'field_al_plan_row_price',
                            'label'       => 'Price',
                            'name'        => 'price',
                            'type'        => 'text',
                            'placeholder' => '830.000 VNĐ',
                        ),
                    ),
                ),
